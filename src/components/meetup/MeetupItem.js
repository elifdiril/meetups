...
function MeetupItem(props) {
  ...
  return (
    <li className="m-4 w-1/3 min-w-[350px]">
      <div className="rounded-lg bg-white shadow-lg p-2">
        ...
        <div className="text-center p-2 overflow-hidden line-clamp-5">
          <h3>{props.title}</h3>
          <address className='overflow-hidden line-clamp-3'>{props.address}</address>
        </div>
